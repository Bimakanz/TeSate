                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ bottom: 20 }}>
                        ...
                        <ButtonPrimary
                            title="Daptar"
                            color="#5CBB5C"
                            onPress={() => { if (validate()) router.push('/Login') }}
                        />
                    </View>
                    <View style={{ bottom: 20, paddingHorizontal: 39 }}>
                        <Text style={{ color: 'black', fontWeight: 'normal', fontSize: 15, textAlign: 'center', paddingBottom: 10, marginBottom: 10 }}>Sudah punya akun? <Text onPress={() => router.push('/Login')} style={{ color: '#5CBB5C', fontWeight: 'normal', textDecorationLine: 'underline' }}>Masuk</Text></Text>
                    </View>
                </View>
            </ScrollView>
        </SafeAreaView>

        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            <View style={{ flex: 1 }}>
                ...
                <View style={{ bottom: 20, paddingHorizontal: 39 }}>
                    <Text style={{ color: 'black', fontWeight: 'normal', fontSize: 15, textAlign: 'center', paddingBottom: 10, marginBottom: 10 }}>Belum punya akun? <Text onPress={() => router.push("/Start/Register")} style={{ color: '#5CBB5C', fontWeight: 'normal', textDecorationLine: 'underline' }}>Daptar heula !</Text></Text>
                </View>
            </View>
        </SafeAreaView>
    )
